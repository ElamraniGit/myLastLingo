            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <input
                  ...
                  className={inp()}
                />
                <p className="text-sm text-faint text-center">Optional — leave blank to use your username</p>
              </div>
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  />
                  {errors.username && <p className="text-sm text-red-400 mt-1 ml-1">{errors.username}</p>}
                </div>
                ...
                <div>
                  ...
                  {errors.password && <p className="text-sm text-red-400 mt-1 ml-1">{errors.password}</p>}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.confirmPwd && <p className="text-sm text-red-400 mt-1 ml-1">{errors.confirmPwd}</p>}
                </div>
              </div>
